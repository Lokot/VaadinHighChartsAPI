...
public class SplineChartSeries extends HighChartsSeriesImpl {
	...
	private ChartType type = ChartType.SPLINE;
	...
	public String getHighChartValue() {
		...
		builder.append("{ name: '" + this.sName + "'," + " type: '"
				+ this.type.getHighChartValue() + "',");
		if (this.yAxis != null) {
			builder.append(" yAxis: " + this.yAxis + ",");
		}
		builder.append("visible: " + isVisible() + ",");
		builder.append("data: [");
	...
	public void addData(TimeNomberData stringIntData) {
		this.data.add(stringIntData);
	}
